...
#โปรเจกต์นี้เป็นส่วนหนึ่งของวิชา Problem Solving in IT ในช่วงศึกษาชั้นปีที่ 1 ซึ่งเป็นช่วงเริ่มต้นของการเรียนรู้การเขียนโปรแกรมและการพัฒนาซอฟต์แวร์ โจทย์ของวิชาคือการออกแบบและสร้างสรรค์เกมด้วยภาษา Python โดยใช้ไลบรารี Pygame Zero
ตัวเกมถูกออกแบบเพื่อฝึกฝนทักษะพื้นฐานด้าน Logic, Game Loop, Collision Detection และการจัดการ State ต่างๆ ของเกม ถือเป็นจุดเริ่มต้นสำคัญในการก้าวเข้าสู่งานด้าน Software Development และการแก้ปัญหาเชิงตรรกะ
...
---
<center>
<img width="600" height="600" alt="image" src="https://github.com/user-attachments/assets/8b533b1e-de7e-4f42-bfe3-80b079b57fe4" />
